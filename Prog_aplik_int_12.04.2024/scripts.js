document.addEventListener('DOMContentLoaded', function(){
  //console.log("test");
	...
	function createTaskElement(taskText){
		...
		subtaskInput.placeholder = 'Dodaj podadanie';
		...
		addSubtaskForm.addEventListener('submit', function(event){
			...
			if (subtaskText === '') {
				alert('Proszę wpisać podzapytanie!');
				return;
			}
			//tworzenie i dodawanie podzapytań do listy podzapytań
	...
	//funkcja odczytująca stan listy zadań w pamięci lokalnej
	function loadTasks(){
